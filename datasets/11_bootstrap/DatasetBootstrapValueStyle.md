...
the **_second part_** sets the display styles for bootstrap values in the range defined in the first part. The 2nd part should be written similarly to the value of **'!bootstrapValueStyles'**.
